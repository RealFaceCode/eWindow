...
namespace ewin
{
    ...
    namespace expr
    {
        constexpr int MaxButton = static_cast<int>(enums::Button::LAST) + 1;
        constexpr int MaxKey = static_cast<int>(enums::Key::LAST) + 1;
    }
    ...
    namespace structs
    {
        ...
        struct WInput
        {
            Button button[expr::MaxButton];
            Button buttonReset[expr::MaxButton];
            Key key[expr::MaxKey];
            Key keyReset[expr::MaxKey];
            Cursor cursor;
            Scroll scroll;
            Drops drops;
            enums::CurserEnter cursorEnter;
